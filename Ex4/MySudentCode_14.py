...
while client.is_running() == 'true':
    ...
    # refresh surface
    # screen.fill(IMAGE_SCREEN_BACKGROUND)#)Color(0, 0, 0))
    ...
    #     if n >= 1000 and n <2000:  # if the node is a node in the graph - continue
    #         ag = graph_x.nodes.get(n)
    #         start_pos_agent[n] = ag
    #     if n >= 2000:  # if p in an  pokemon
    #         p = graph_x.nodes.get(n)
    #         start_pos_pokeon[n] = p
    # print(f"========================================== start_pos_agent = {start_pos_agent}")
    # print(f"========================================== start_pos_pokeon = {start_pos_pokeon}")
    # for a in start_pos_agent.keys():
    #     graph_x.nodes.get(a)['pos'] = graph_x.nodes.get(a+1000)['pos']
    #
    # print(f"------------------ {graph_x.nodes.data()}")
